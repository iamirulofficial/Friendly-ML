/*! p5.js v0.9.0 July 01, 2019 */ ! function(t, e) {
	...
	function i(t, e, i, n) {
		...
		for(var t, e, i = !0, n = !0, r = 0; r < arguments.length; r++) arguments[r] === d.prototype.VIDEO ? n = !1 : arguments[r] === d.prototype.AUDIO ? i = !1 : "object" == typeof arguments[r] ? t = arguments[r] : "function" == typeof arguments[r] && (e = arguments[r]);
		...
		return s.loadedmetadata = !1, o.addEventListener("loadedmetadata", function() {
			o.play(), o.width ? (s.width = o.videoWidth = o.width, s.height = o.videoHeight = o.height) : (s.width = s.elt.width = o.videoWidth, s.height = s.elt.height = o.videoHeight), s.loadedmetadata = !0, e && e(o.srcObject)
		}), s
		...
		if(this.canvas || (this.canvas = document.createElement("canvas"), this.drawingContext = this.canvas.getContext("2d"), this.setModified(!0)), this.loadedmetadata) {
			...
			(this._pixelsDirty || this._pixelsTime !== t) && (this._pixelsTime = t, this._pixelsDirty = !0, this.drawingContext.drawImage(this.elt, 0, 0, this.canvas.width, this.canvas.height), this.setModified(!0))
		}
